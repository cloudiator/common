...
import org.cloudiator.messaging.*;
 ...
 */
@Singleton class KafkaMessageInterface implements MessageInterface {
    ...
    @Inject KafkaMessageInterface(KafkaProducerFactory kafkaProducerFactory,
    ...
    @Override public void publish(String topic, String id, Message message) {
        LOGGER.debug(
    ...
    @Override public <T extends Message, S extends Message> S call(String requestTopic, T request,
    ...
    @Override public void reply(String originId, Message message) {
    ...
    @Override public void reply(String topic, String originId, Message message) {
    ...
    @Override public void reply(String topic, String originId, Error error) {
    ...
    private class KafkaRequestResponseHandler {
        ...
        private class SyncResponse<S> {
            ...
            @Nullable private S content = null;
