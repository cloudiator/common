...
public class PasswordTest {
  ...
  /**
   * Checks the singleton pattern. <p> Checks that the instance method returns an instance of
   * Password and that subsequent calls to getInstance return the same instance.
   */
  @Test
  ...
  /**
   * Checks the generateSalt method. <p> The salt should have a length of 32 byte and two calls
  ...
  /**
   * Checks the hash method. <p> - The generated hash of two times the same password and salt must
   * be equal. - The hash of the same password but different salts must not be equal. - The hash of
   * the same salt but different passwords must not be equal. - the hash must reach at least 512
   * bit.
   */
  @Test
  ...
  /**
   * Checks the test method. <p> - If provided with the correct password and salt for the hash the
   * test method must return true. - If provided with the incorrect password for the hash the test
   * method must return false. - If provided with the incorrect salt for the hash the test method
   * must return false.
   */
  @Test
