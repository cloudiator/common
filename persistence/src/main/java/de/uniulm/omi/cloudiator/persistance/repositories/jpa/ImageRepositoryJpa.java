...
import de.uniulm.omi.cloudiator.persistance.repositories.ImageRepository;
...
class ImageRepositoryJpa extends BaseRemoteResourceRepositoryJpa<Image> implements ImageRepository {
    ...
    @Inject public ImageRepositoryJpa(Provider<EntityManager> entityManager, TypeLiteral<Image> type) {
