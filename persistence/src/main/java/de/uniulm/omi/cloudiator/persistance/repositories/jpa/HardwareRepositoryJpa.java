...
import de.uniulm.omi.cloudiator.persistance.repositories.HardwareRepository;
...
class HardwareRepositoryJpa extends BaseRemoteResourceRepositoryJpa<Hardware>
    ...
    @Inject public HardwareRepositoryJpa(Provider<EntityManager> entityManager, TypeLiteral<Hardware> type) {
