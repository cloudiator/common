...
class BaseModelRepositoryJpa<T extends Model> implements ModelRepository<T> {
    ...
    @SuppressWarnings("unused") private final Provider<EntityManager> entityManager;

    @Inject BaseModelRepositoryJpa(Provider<EntityManager> entityManager, TypeLiteral<T> type) {
