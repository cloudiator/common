...
public class FrontendUser extends Model {
  ...
  /**
   * Constructs a frontend user from the given information. <p> This constructor takes the clear
   * text password, generates a salt for the given password and hashes it using the generated salt.
   *
   * @param firstName First name of the user.
   * @param lastName Last name of the user.
